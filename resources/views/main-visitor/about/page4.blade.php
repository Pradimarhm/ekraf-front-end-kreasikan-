    ...
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-6 lg:py-16 lg:grid-cols-12 items-center">
        ...
        <div class="mb-6 lg:mb-0 lg:mt-0 mt-5 lg:col-span-5 lg:flex order-first justify-center">
            <div class="overflow-hidden rounded-xl flex justify-center aboutpage4-textboxRight15">
                <svg class="w-full max-w-[32rem] h-auto text-gray-800 dark:text-white block dark:hidden" aria-hidden="true" width="806"
                    ...
                    <path class="aboutpage4-svgFloat"
                        ...
                        fill="#d6e2fb" />
                    <path class="aboutpage4-svgFloat" fill-rule="evenodd" clip-rule="evenodd" d="M40 69H708V70H40V69Z" fill="#c8d8fa" />
                    <path class="aboutpage4-svgFloat"
                ...
                <svg class="w-full max-w-[32rem] h-auto text-gray-800 dark:text-white hidden dark:block" aria-hidden="true"
                    width="806" height="593" viewBox="0 0 806 593" fill="none"
                    ...
                    <path class="aboutpage4-svgFloat"
                        d="M40 56.0003C39.9998 52.6865 42.6862 50 46 50L702.001 50C705.314 50 708.001 52.6863 708.001 56V69H40.0006L40 56.0003Z"
                        fill="#1C2634" />
                    <path class="aboutpage4-svgFloat" fill-rule="evenodd" clip-rule="evenodd" d="M40 69H708V70H40V69Z" fill="#374151" />
                    <path class="aboutpage4-svgFloat"
